...
const ProjectCard = ({title,src}) => {
  return (
    <div className='flex h-[450px] flex-col justify-center items-center text-center w-[100%]  cursor-pointer'>
    <div className='relative z-0  overflow-hidden  min-w-[100%] '>
      ...
      <div className="hover:scale-125 transition-all ease-in-out duration-500 ">
        <img className='w-full min-h-[450px] object-cover object-center' src={src} alt="Image"/>
      </div>
