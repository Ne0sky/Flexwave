...
const Navbar_portfolio = () => {
  return (
    <div className='w-screen h-24  flex  flex-col md:flex-row items-center my-4 justify-center  '>
        ...
        <NavLink className='rounded-3xl lg:text-xl hover:bg-zinc-900 hover:text-white transition-all duration-300 border border-black px-2 lg:px-6 py-2 text-center mx-1 lg:mx-4'  to='/portfolio/all' >All Projects</NavLink>
        ...
        <NavLink className='rounded-3xl lg:text-xl hover:bg-zinc-900 hover:text-white transition-all duration-300 border border-black px-2 lg:px-6 py-2 text-center mx-1 lg:mx-4'  to='/portfolio/banner' >Hoardings</NavLink>
