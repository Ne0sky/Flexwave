...
const Banner = () => {
  ...
  return (
    <div>
        ...
        <div className='w-3/4 lg:w-1/2 flex items-center justify-center'>
        ...
        <div className=' text-xl md:text-2xl z-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-60 flex flex-col items-center justify-center'><p>Scroll Down</p> <HiChevronDoubleDown className='pt-4 text-4xl md:text-6xl text-zinc-900 animate-bounce'/></div>
